...
class QuizController extends Controller
{
    ...
    public function RedirectToAppropriatePanel()
    {
        if (Auth::user()) {
            ...
            if ($id && Auth::check() && Auth::user()->permissions == 0) { //The user is the administrator
            ...
            } else if (Auth::check() && Auth::user()->permissions == 1) { //The user is a teacher
                $subjects = Subject::all();
                $classes = Classe::with('subject')
            ...
            } else if (Auth::check() && Auth::user()->permissions == 2) { //The user is a student
    ...
    public function JoinClass(Request $request)
    {
        ...
        $is_joined = StudentClasse::where('class_id', $request->input('class_code'))
