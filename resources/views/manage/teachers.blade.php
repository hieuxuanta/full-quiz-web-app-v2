...
@section('content')
    ...
    <div class="container">
                    ...
                    <tbody>
                        @foreach ($teachers as $t)
                            <tr>
                                ...
                                <td>
                                    <button href="" class="btn btn-danger btn-sm" type="button"
                                        class="btn btn-primary btn-sm" data-toggle="modal" data-target="#deleteTeacher"
                                        data-tid="{{ $t->usr_id }}">
                                        <i class="fa fa-trash-o" aria-hidden="true"></i>
                                    </button>
                                    <button href="" class="btn btn-warning btn-sm" type="button"
                                        class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#resetTeacherPassword" data-tid="{{ $t->usr_id }}">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/account">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted text-center">By clicking "Register", the teacher agrees
                                    to our terms of service and privacy policy.</small>
                            </div>
        ...
        <div class="modal fade" id="resetTeacherPassword" tabindex="-1" role="dialog" aria-labelledby="resetTeacherPassword"
            aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" onclick="ResetTeacherPassword()">Reset
                            password</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="resetTeacherPasswordSuccess" tabindex="-1" role="dialog"
            aria-labelledby="resetTeacherPassword" aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="deleteTeacher" tabindex="-1" role="dialog" aria-labelledby="DeleteSubjectModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Are you sure you want to delete this teacher? Any classes under this teacher will also be deleted.
