                ...
                <form class="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            <input type="text" class="form-control m-1" placeholder="Full Name" id="f-name" style="width:12rem" disabled>
                            ...
                            <input type="text" class="form-control m-1" placeholder="Extension Name - Mr / Ms" id="ne-name" style="width:12rem" disabled>
                        </div>
                    </div>
                    <div class="form-group">
