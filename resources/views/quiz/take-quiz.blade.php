            ...
            <div class="row">
                <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
                    <ul class="nav nav-pills flex-column">
                        <li class="nav-item disabled"><a class="nav-link disabled" style="font-size: 2rem; text-align: center">BQuiz</a></li>
                        <li class="nav-item">
                ...
                <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
                    <form class="tab-content col" id="v-pills-tabContent" action="/take" method="POST">
                        ...
                        <div class="tab-pane fade show active" id="welcome" role="tabpanel" aria-labelledby="welcome">
                            ...
                            <button type="button" id="enablequizbtn" class="btn btn-primary" onclick="enableQuiz()">Yes, this is correct</button>
                            <button type="button" id="enablequizbtn" class="btn btn-outline-primary"><a href="/panel">No, turn back!</a></button>
